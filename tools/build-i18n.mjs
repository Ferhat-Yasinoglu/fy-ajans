...
const SOURCES = ['index.html', 'claude/index.html', 'contact/index.html', 'contact/course.html', 'course/chapter-1.html', 'course/chapter-2.html', 'course/chapter-3.html', 'course/chapter-4.html', 'course/chapter-5.html', 'course/chapter-6.html', 'course/chapter-7.html', 'portal/login.html', 'terms.html', 'impressum.html'];
...
function translate(src, html, dict, report) {
  ...
  //    data-live de buraya dahil: bölüm kapağının canlı sürümünün yolu; çevrilmiş sayfalarda yeniden yazılmazsa
  //    kart canlanınca 404 alıyor ve görsel kayboluyordu.
  const d = depthOf(src);
  html = html.replace(/\b(href|src|srcset|content|data-live)="((?:\.\.\/)*)([^"]+)"/g, (all, a, ups, rest) => {
...
const PRIO = { 'index.html': ['weekly', '1'], 'claude/index.html': ['monthly', '0.8'], 'course/chapter-1.html': ['monthly', '0.7'], 'course/chapter-2.html': ['monthly', '0.7'], 'course/chapter-3.html': ['monthly', '0.7'], 'course/chapter-4.html': ['monthly', '0.7'], 'course/chapter-5.html': ['monthly', '0.7'], 'course/chapter-6.html': ['monthly', '0.7'], 'course/chapter-7.html': ['monthly', '0.7'], 'contact/index.html': ['weekly', '0.9'], 'contact/course.html': ['weekly', '0.8'], 'terms.html': ['monthly', '0.3'], 'impressum.html': ['yearly', '0.2'], 'portal/login.html': null };
